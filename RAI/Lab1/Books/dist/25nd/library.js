...
class Library {
  ...
  searchExact(criterias) {
    ...
    //#NF:15 short if ?:
    return [...this.#books.entries()].flatMap(_ref3 => {
      let [book, books] = _ref3;
      return Object.entries(criterias).every(_ref4 => {
        let [key, value] = _ref4;
  ...
  searchRE(criterias) {
    ...
    return Array.from(this.#books.entries()).filter(_ref5 => {
      let [book, _] = _ref5;
      return Object.entries(criterias).every(_ref6 => {
        let [key, value] = _ref6;
